...
def test_list_notebooks_empty(setup, setup_sqlite, scene_root, library_root, library_db, current_scene_db, start, stop):
...
def test_list_notebooks_populated(setup, setup_sqlite, add_test_library, scene_root, library_root, library_db, current_scene_db, start, stop, notebooks_list):
    from src.mtool.notebook import list_notebook
    notebooks = list_notebook.list_notebook(scene_root, library_root, library_db, current_scene_db, start, stop)
